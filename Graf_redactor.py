...
br_txt.goto(0, 270)
br_txt.pendown()
br_txt.write('Кисть', align='center', font=('Аrial', 14, 'bold'))
br_txt.penup()
br_txt.goto(0, 270)
...
def move_up():
    y = kb.ycor()
    kb.sety(y + 20)
    kb.pencolor(random.randint(0, 255), random.randint(
...
kb_txt.goto(-150, 270)
kb_txt.pendown()
kb_txt.write('Карандаш', align='center', font=('Arial', 14, 'bold'))
kb_txt.penup()
kb_txt.goto(-100, 270)
# Надпись kb
kb = turtle.Turtle()
